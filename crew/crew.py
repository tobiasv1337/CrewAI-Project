...
from crew.tools import MOSES_MODULE_RESEARCH_TOOLS


@CrewBase
class StudyAssistantCrew:
    """CrewAI entry point for the TU Study Assistant."""
    ...
    @task
    def module_research_task(self) -> Task:
        return Task(
            config=self.tasks_config["module_research_task"],  # type: ignore[index]
            markdown=True,
        )

    @crew
    def crew(self) -> Crew:
        """Create the Phase 2 single-agent module research crew."""
