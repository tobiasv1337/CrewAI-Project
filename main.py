...
def build_parser() -> argparse.ArgumentParser:
    ...
    ask_multi_parser.add_argument("--manager-model", help="Override the model used for intent classification and the orchestrator, with thinking when supported.")
    ask_multi_parser.add_argument("--observer-model", help="Override the non-thinking model used for proposal-decision interpretation and progress summaries.")
